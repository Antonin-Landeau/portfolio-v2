...
const Filter = ({
  ...
  return (
    ...
    >
      <div className="flex items-center border-b-[1px] border-b-secondary-font">
      ...
      <div className="fixed flex z-20 w-full bg-default-white bottom-0 left-1/2 -translate-x-1/2 py-5">
        <button
          type="submit"
